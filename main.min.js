...
;// CONCATENATED MODULE: ./src/libs/component.js
class Component {
  constructor(element) {
    this.element = element;
  }
  /**
   * Function which call when component initialized
   * @interface
   */
...
;// CONCATENATED MODULE: ./src/components/NavBarCollapse.js
  ...
  _proto.mount = function mount(el) {
    ...
    var getWrapper = function getWrapper() {
      if (el && el.shadowRoot && el.shadowRoot.querySelector) {
        var res = dom(el.shadowRoot.querySelector("." + swiper.params.wrapperClass)); // Children needs to return slot items
...
core_class.use([pagination, navigation]);
...
class Slider extends Component {
  ...
  slider() {
    ...
    const slider = new core_class(this.element, optionsDefault);
  }
...
;// CONCATENATED MODULE: ./src/utils/bootstrap.js
